"""
Django settings for taherdoust_com project.
...
SECRET_KEY = 'django-insecure-6*bs@(8^4e))zzk=3(tx2n!1_x^^9w+=fhxk6&a!=8y5-k5+ng'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'taherdoust.pythonanywhere.com',  # Your domain
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # WhiteNoise support
    'weblog',
]
...
ROOT_URLCONF = 'taherdoust_com.urls'
...
WSGI_APPLICATION = 'taherdoust_com.wsgi.application'
